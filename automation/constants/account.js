export const WALLET_ACCOUNT = Object.freeze({
  ...
  AMEX_GOLD: 'American Express Gold Card',
  ...
  CHASE_AMAZON: 'Amazon Prime Rewards Visa Signature',
  CHASE_FREEDOM_UNLIMITED: 'Chase Freedom Unlimited',
  WELLS_FARGO_PLATINUM: 'Wells Fargo Autograph (Platinum)',
  WELLS_FARGO_CHECKING: 'Wells Fargo Checking',
  WELLS_FARGO_ACTIVE_CASH: 'Wells Fargo Active Cash',
  AMEX_BLUE: 'American Express Blue Cash Preferred',
